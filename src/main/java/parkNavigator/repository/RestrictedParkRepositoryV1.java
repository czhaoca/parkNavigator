...
import parkNavigator.Mapper.ParkCombineMapper;
import parkNavigator.Mapper.RestrictedParkMapper;
...
public class RestrictedParkRepositoryV1 extends ParkRepositoryV1 {
  ...
  public RestrictedPark getById(int id) {
    return (RestrictedPark) jdbcTemplate.queryForObject("select * from Restricted_park where id = ?",
        new RestrictedParkMapper(), id);
  }
