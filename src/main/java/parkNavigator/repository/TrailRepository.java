...
////import parkNavigator.Mapper.TrailImageMapper;
//import parkNavigator.Mapper.TrailLevelMapper;
//import parkNavigator.Mapper.TrailSeasonMapper;
//import parkNavigator.Mapper.TrailInfoMapper;
//
...
public class TrailRepository {
  ...
  public List<TrailDto> divisionBySeason(int parkId, String seasonName) {
    // String sql =
    // "select t.trail_name from trail_season t join SEASONS s on t.season_name =
    // s.season_name\n" +
    ...
    String sql = "SELECT t.trail_name " +
        "FROM trail_info t " +
